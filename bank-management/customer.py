...
class Customer:
    ...
    # def createuser(self):
    #     db_query (f"INSERT INTO customers VALUES (username, password, name, age, city, account_number) ('{self.__username}', '{self.__password}', '{self.__name}', {self.__age}, '{self.__city}', {self.__account_number} , '1' );")
    #     mydb.commit()
